...
import { Link2, BarChart3, ExternalLink, Scissors, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="space-y-4">
          {links.map(link => (
            <div key={link.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl flex justify-between items-center">
              <div>
                <span className="text-xl font-bold text-indigo-600 dark:text-indigo-400">{link.short_url}</span>
